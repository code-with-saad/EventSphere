      ...
      <AuthProvider>
        <Router>
          ...
          <Routes>
            ...
            <Route path="/admin/reports" element={<ProtectedRoute allowedRoles={['superadmin']}><SuperAdminAnalyticsPage /></ProtectedRoute>} />
            <Route path="/superadmin/reports" element={<Navigate to="/admin/reports" replace />} />
