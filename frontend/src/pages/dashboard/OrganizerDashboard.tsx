...
export default function OrganizerDashboard() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-xl-token font-semibold mb-sm-token">Organizer Dashboard</h1>
        <p className={`text-sm-token ${isDarkMode ? 'text-text-secondary-dark' : 'text-text-secondary-light'}`}>
          Coming soon — event management capabilities will be available in a future phase.
        </p>
      </div>
    </div>
  );
