...
5. If you cannot use a real inbox in development, set `DEV_OTP_BYPASS=true` in `backend/.env` - the OTP will be printed to the backend console (see Key Technical Decisions -).
